...
/// Configure the pallet-mydropbox in pallets/mydropbox.
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: pallet_sudo,
		// Include the custom logic from the pallet-mydropbox in the runtime.
		TemplateModule: pallet_mydropbox,
	}
);
